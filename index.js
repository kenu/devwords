function getString() {
  const array = [
    ...
    "2025 프로그래머의 최대 비밀: 'AI 프롬프트를 얼마나 잘 작성하느냐'가 실제 기술력의 90%를 차지한다.",
    ...
    "ChatGPT에게 물어보면 된다고? 그 답변을 디버깅하는 시간이 더 오래 걸린다.",
    "AI가 짠 코드는 돌아가지만, 왜 돌아가는지는 AI도 모른다.",
    "프롬프트 엔지니어링: 컴퓨터에게 부탁하는 법을 배우는 새로운 예술.",
    "GPT에게 코드를 물어보는 것은 빠르지만, 그 코드를 이해하는 것은 여전히 느리다.",
    "AI 시대의 개발자: 코드를 짜는 사람에서 코드를 검증하는 사람으로.",
    "Copilot이 자동완성 해준 코드, 믿고 쓰다가 3일 뒤 버그로 돌아온다.",
    "AI가 10분만에 짠 코드를 이해하는데 2시간이 걸린다.",
    "ChatGPT: 당신의 질문에 자신감 넘치게 틀린 답을 제공합니다.",
    "AI 시대에도 변하지 않는 진리: 복붙한 코드는 반드시 문제를 일으킨다.",
    "GPT가 짠 코드 리뷰하다 보면, 내가 짜는 게 더 빠르다는 걸 깨닫는다.",
    "AI에게 물어보기 전에 구글링하던 시절이 그립다. 적어도 Stack Overflow는 정직했다.",
    "프롬프트를 10번 수정하는 시간에 그냥 내가 짜는 게 낫다.",
    "AI가 생성한 코드의 주석을 믿지 마라. AI도 자기가 뭘 짰는지 모른다.",
    "ChatGPT에게 버그 수정을 부탁했더니 새로운 버그 3개를 선물로 줬다.",
    "AI 시대의 시니어 개발자: AI가 만든 코드의 거짓말을 간파하는 사람.",
    "Copilot 자동완성을 믿고 탭을 누르는 순간, 당신은 이미 기술부채를 쌓고 있다.",
  ];
